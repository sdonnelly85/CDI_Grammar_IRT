...
```
No idea why this word is missing. I'm removing all these participants from the IRT models. This participant had a score on vocab, so it will lead to 1 more missing value in the final models. 
...
p1 <- true_raw/(true_score + raw_score) + theme_minimal() 
ggsave("plots/PredictedVocab.png", last_plot(), height=3, width=4, dpi=300, unit="in")
```
...
ggsave("plots/DiscDimVocab.png", last_plot(), height=3, width=4, dpi=300, unit="in")
```
